...
#             self.marks.extend([None] * off) # [5, 5, 4, 4, 5, None, None, None, None, None, None]
#
#         self.marks[key] = value #[5, 5, 4, 4, 5, None, None, None, None, None, 4]
#
...
# print(max_users)
#
# print(f"Полльзователи {max_users} выполнили {max_complete} задач")
